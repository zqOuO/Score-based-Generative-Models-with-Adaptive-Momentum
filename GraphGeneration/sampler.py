...
class Sampler(object):
    ...
    def sample(self):
        ...
        self.configt.sde.x.num_scales = self.config.sample.steps
        self.configt.sde.adj.num_scales = self.config.sample.steps
        ...
        self.model_x.to(self.device)
        self.model_adj.to(self.device)
