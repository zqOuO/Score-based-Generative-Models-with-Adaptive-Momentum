...
INCEPTION_TFHUB = 'https://storage.googleapis.com/tfhub-modules/tensorflow/tfgan/eval/inception/1.tar.gz'
...
def get_inception_model(inceptionv3=False):
  if inceptionv3:
    return tfhub.load(
      'https://storage.googleapis.com/tfhub-modules/google/imagenet/inception_v3/feature_vector/4.tar.gz')
